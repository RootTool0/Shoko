...
<div style="display: flex; align-items: center; justify-content: center;">
  <h1 style="margin: 0; text-align: center; max-width: 60%;">
    «С помощью этого блокнота мы сможем общаться. Давайте будем друзьями»
  </h1>
  <img src="ReadMeAssets/1.png" style="width:30vw; margin-left:60px;">
</div>

---

<div align="center">
<h2>Экспериментальный UI-фреймворк на C++17, где интерфейс строится и валидируется во время компиляции</h2>
<p>
...
Человечность в ошибках. Ошибки компиляции - не провал, а продолжение диалога. Shoko не кричит `static_assert failed`. Она вежливо объясняет:
...
<img src="ReadMeAssets/4.png" style="float: left; margin-right: 60px; width:24vw; max-width: 300px">
